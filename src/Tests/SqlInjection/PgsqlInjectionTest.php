...
class PgsqlInjectionTest extends AbstractPgsqlAdapterTestCase
{
    public function testTableInjection()
    {
        // Vulnerability: quoteTable only wraps in double quotes, doesn't escape double quotes.
    ...
    {
        // Vulnerability: quoteTable (used for columns in Insert) doesn't escape double quotes.
